...
async function getPromotions(req, res, next) {
  const { error } = promotion_Validator.queryPromotionSchema.validate(req.query);
...
async function deletetPromotions(req, res, next) {
  const { error } = promotion_Validator.deletePromotionSchema.validate(req.body);
